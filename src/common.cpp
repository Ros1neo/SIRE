...
bool toBool(const std::string &str) {
    ...
    if (value == "false")
        ...
        throw SireException("Could not parse boolean value \"%s\"", str);
}
...
int toInt(const std::string &str) {
    ...
    if (*end_ptr != '\0')
        throw SireException("Could not parse integer value \"%s\"", str);
    return result;
}
...
float toFloat(const std::string &str) {
    ...
    if (*end_ptr != '\0')
        throw SireException("Could not parse floating point value \"%s\"", str);
    return result;
}
...
Eigen::Vector3f toVector3f(const std::string &str) {
    ...
    if (tokens.size() != 3)
        throw SireException("Expected 3 values");
...
Eigen::Quaternionf toQuaternionf(const std::string &str) {
    std::vector<std::string> tokens = tokenize(str);
    if (tokens.size() != 4)
        throw SireException("Expected 4 values");
